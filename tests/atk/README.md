...
## 已生成的 ATK 项目
以下算子项目按 `chunk_kda_fwd` 的 ATK 布局生成。

| 算子 | 公开 API | ACLNN 名称 | case 数 | 备注 |
| --- | --- | --- | --- | --- |
| [`add_example`](./add_example/) | `fla_npu.ops.ascendc.add_example` | `AddExample` | 2 | 示例算子注册在 examples/add_example 下；fla_npu.ops.ascendc 暂无公开 ctypes wrapper。 |
| [`fast_gelu_custom`](./fast_gelu_custom/) | `fla_npu.ops.ascendc.fast_gelu_custom` | `FastGelu` | 3 | - |
| [`fast_gelu_custom_backward`](./fast_gelu_custom_backward/) | `fla_npu.ops.ascendc.fast_gelu_custom_backward` | `FastGeluBackward` | 3 | - |
| [`prepare_wy_repr_bwd_full`](./prepare_wy_repr_bwd_full/) | `fla_npu.ops.ascendc.prepare_wy_repr_bwd_full` | `PrepareWyReprBwdFull` | 2 | - |
| [`chunk_gated_delta_rule_bwd_dhu`](./chunk_gated_delta_rule_bwd_dhu/) | `fla_npu.ops.ascendc.chunk_gated_delta_rule_bwd_dhu` | `ChunkGatedDeltaRuleBwdDhu` | 2 | - |
| [`chunk_bwd_dv_local`](./chunk_bwd_dv_local/) | `fla_npu.ops.ascendc.chunk_bwd_dv_local` | `ChunkBwdDvLocal` | 2 | - |
| [`prepare_wy_repr_bwd_da`](./prepare_wy_repr_bwd_da/) | `fla_npu.ops.ascendc.prepare_wy_repr_bwd_da` | `PrepareWyReprBwdDa` | 2 | - |
| [`chunk_bwd_dqkwg`](./chunk_bwd_dqkwg/) | `fla_npu.ops.ascendc.chunk_bwd_dqkwg` | `ChunkBwdDqkwg` | 2 | - |
| [`chunk_fwd_o`](./chunk_fwd_o/) | `fla_npu.ops.ascendc.chunk_fwd_o` | `ChunkFwdO` | 2 | - |
| [`chunk_gated_delta_rule_fwd_h`](./chunk_gated_delta_rule_fwd_h/) | `fla_npu.ops.ascendc.chunk_gated_delta_rule_fwd_h` | `ChunkGatedDeltaRuleFwdH` | 2 | - |
| [`recompute_w_u_fwd`](./recompute_w_u_fwd/) | `fla_npu.ops.ascendc.recompute_w_u_fwd` | `RecomputeWUFwd` | 2 | - |
| [`chunk_local_cumsum`](./chunk_local_cumsum/) | `fla_npu.ops.ascendc.chunk_local_cumsum` | `ChunkLocalCumsum` | 2 | - |
| [`chunk_scaled_dot_kkt`](./chunk_scaled_dot_kkt/) | `fla_npu.ops.ascendc.chunk_scaled_dot_kkt` | `ChunkScaledDotKkt` | 2 | - |
| [`solve_tri`](./solve_tri/) | `fla_npu.ops.ascendc.solve_tri` | `SolveTri` | 2 | - |
| [`causal_conv1d`](./causal_conv1d/) | `fla_npu.ops.ascendc.causal_conv1d` | `CausalConv1d` | 2 | - |
| [`causal_conv1d_bwd`](./causal_conv1d_bwd/) | `fla_npu.ops.ascendc.causal_conv1d_bwd` | `CausalConv1dBwd` | 2 | - |
| [`chunk_kda_bwd_intra`](./chunk_kda_bwd_intra/) | `fla_npu.ops.ascendc.chunk_kda_bwd_intra` | `ChunkKdaBwdIntra` | 2 | - |
| [`kda_gate_cumsum`](./kda_gate_cumsum/) | `fla_npu.ops.ascendc.kda_gate_cumsum` | `KdaGateCumsum` | 2 | - |
| [`recurrent_kda`](./recurrent_kda/) | `fla_npu.ops.ascendc.recurrent_kda` | `RecurrentKda` | 2 | - |
| [`recurrent_gated_delta_rule`](./recurrent_gated_delta_rule/) | `fla_npu.ops.ascendc.recurrent_gated_delta_rule` | `RecurrentGatedDeltaRule` | 1 | 已在 OPP 中注册，但 fla_npu.ops.ascendc 暂无公开 ctypes wrapper。 |
