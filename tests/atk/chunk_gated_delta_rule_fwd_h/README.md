...
k/w=[B,HK,T,K], u/v_new=[B,HV,T,V], h=[B,HV,num_chunks,K,V]; B=1, HK=1, HV=1, T=16, K=128, V=128, chunk_size=64.
...
- `bf16_small`: `{"name": "bf16_small", "dtype": "bf16", "B": 1, "HK": 1, "HV": 1, "T": 16, "K": 128, "V": 128, "chunk_size": 64, "op": "chunk_gated_delta_rule_fwd_h", "case_id": 0, "seed": 20260817, "route": "ascendc", "soc": "ascend910b"}`
- `fp16_small`: `{"name": "fp16_small", "dtype": "fp16", "B": 1, "HK": 1, "HV": 1, "T": 16, "K": 128, "V": 128, "chunk_size": 64, "op": "chunk_gated_delta_rule_fwd_h", "case_id": 1, "seed": 20260818, "route": "ascendc", "soc": "ascend910b"}`
