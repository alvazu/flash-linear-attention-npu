"""prepare_wy_repr_bwd_full 的 ATK executor。
...
def run_npu(spec: dict[str, Any], input_data: InputDataset):
    ...
    return ascendc.prepare_wy_repr_bwd_full(inputs["k"], inputs["v"], inputs["beta"], inputs["A"], inputs["dA"], inputs["dw"], inputs["du"], inputs["g"], inputs["chunk_size"], cu_seqlens=None, chunk_indices=None)
